...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>Call Girls in Bangalore | 24/7 Service | 8860976606</title>
        <meta name="description" content="Gorgeous call girls in Bangalore available 24/7. Book for full night service. Call 8860976606 for best escorts in Bangalore." />
        <meta name="keywords" content="Bangalore call girls, call girls in Bangalore, escorts, 24/7 service, full night booking" />
      </Helmet>
      
      <div className="max-w-4xl mx-auto p-4 bg-gradient-to-b from-pink-50 to-purple-50 min-h-screen">
        <h1 className="text-3xl font-bold text-center text-pink-700 mb-6 p-4 bg-white rounded-lg shadow-md">
          Call girls in Bangalore 8860976606<br />
          <span className="text-2xl">ↇGorgeousↇ Bangalore Call Girl</span><br />
          <span className="text-xl">24/7 service Available</span>
        </h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mb-8">
          ...
          <ul className="space-y-3">
            <li className="bg-pink-100 p-3 rounded hover:bg-pink-200 transition">
              <a href="tel:8860976606" className="text-pink-700 font-medium">
                Bangalore call girls 8860976606 ⫷☆69 Position☆⫸ call girls in Bangalore Book for Full Night
              </a>
            </li>
            <li className="bg-pink-100 p-3 rounded hover:bg-pink-200 transition">
              <a href="tel:8860976606" className="text-pink-700 font-medium">
                Call girls in Bangalore 8860976606 ↇGorgeousↇ Bangalore Call Girl 24/7 service Available
              </a>
            </li>
          </ul>
        </div>
